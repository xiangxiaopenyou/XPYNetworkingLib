#
# Be sure to run `pod lib lint XPYNetworkingLib.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XPYNetworkingLib.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'XPYNetworkingLib/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XPYNetworkingLib' => ['XPYNetworkingLib/Assets/*.png']
  # }
